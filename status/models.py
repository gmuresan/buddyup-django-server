...
class Location(geomodels.Model):
    ...
    venue = geomodels.CharField(max_length=80, db_index=True, null=True, blank=True)
    address = geomodels.CharField(max_length=100, db_index=True, null=True, blank=True)
