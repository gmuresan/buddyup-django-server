...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Status.visibility'
        db.alter_column(u'status_status', 'visibility', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Status.statusType'
        db.alter_column(u'status_status', 'statusType', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Status.visibility'
        db.alter_column(u'status_status', 'visibility', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Status.statusType'
        db.alter_column(u'status_status', 'statusType', self.gf('django.db.models.fields.CharField')(max_length=10))
