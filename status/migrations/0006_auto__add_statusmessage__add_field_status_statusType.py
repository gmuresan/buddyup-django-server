...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'status_statusmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statusMessages', to=orm['userprofile.UserProfile'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', to=orm['status.Status'])),
        ))
        db.send_create_signal(u'status', ['StatusMessage'])

        # Adding field 'Status.statusType'
        db.add_column(u'status_status', 'statusType',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=10, db_index=True),
                      keep_default=False)

        # Adding M2M table for field attending on 'Status'
        m2m_table_name = db.shorten_name(u'status_status_attending')
        ...
        # Adding M2M table for field invited on 'Status'
        m2m_table_name = db.shorten_name(u'status_status_invited')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('status', models.ForeignKey(orm[u'status.status'], null=False)),
            ('userprofile', models.ForeignKey(orm[u'userprofile.userprofile'], null=False))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'status_statusmessage')

        # Deleting field 'Status.statusType'
        db.delete_column(u'status_status', 'statusType')

        # Removing M2M table for field attending on 'Status'
        db.delete_table(db.shorten_name(u'status_status_attending'))

        # Removing M2M table for field invited on 'Status'
        db.delete_table(db.shorten_name(u'status_status_invited'))
