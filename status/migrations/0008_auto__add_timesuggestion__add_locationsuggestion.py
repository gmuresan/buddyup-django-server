...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimeSuggestion'
        db.create_table(u'status_timesuggestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(related_name='timeSuggestions', to=orm['status.Status'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='timeSuggestions', to=orm['userprofile.UserProfile'])),
            ('dateCreated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('dateSuggested', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'status', ['TimeSuggestion'])

        # Adding model 'LocationSuggestion'
        db.create_table(u'status_locationsuggestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locationSuggestions', to=orm['status.Status'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locationSuggestions', to=orm['userprofile.UserProfile'])),
            ('dateCreated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['status.Location'])),
        ))
        db.send_create_signal(u'status', ['LocationSuggestion'])

        # Adding M2M table for field fbInvited on 'Status'
        m2m_table_name = db.shorten_name(u'status_status_fbInvited')
        ...
        # Adding M2M table for field fbAttending on 'Status'
        m2m_table_name = db.shorten_name(u'status_status_fbAttending')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('status', models.ForeignKey(orm[u'status.status'], null=False)),
            ('facebookuser', models.ForeignKey(orm[u'userprofile.facebookuser'], null=False))
    ...
    def backwards(self, orm):
        # Deleting model 'TimeSuggestion'
        db.delete_table(u'status_timesuggestion')

        # Deleting model 'LocationSuggestion'
        db.delete_table(u'status_locationsuggestion')

        # Removing M2M table for field fbInvited on 'Status'
        db.delete_table(db.shorten_name(u'status_status_fbInvited'))

        # Removing M2M table for field fbAttending on 'Status'
        db.delete_table(db.shorten_name(u'status_status_fbAttending'))
    ...
    models = {
        ...
        u'status.status': {
            ...
            'fbAttending': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'statusesAttending'", 'symmetrical': 'False', 'to': u"orm['userprofile.FacebookUser']"}),
            'fbFriendsVisible': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'statusesVisible'", 'symmetrical': 'False', 'to': u"orm['userprofile.FacebookUser']"}),
            'fbInvited': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'statusesInvited'", 'symmetrical': 'False', 'to': u"orm['userprofile.FacebookUser']"}),
            'friendsVisible': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'statusesVisible'", 'symmetrical': 'False', 'to': u"orm['userprofile.UserProfile']"}),
