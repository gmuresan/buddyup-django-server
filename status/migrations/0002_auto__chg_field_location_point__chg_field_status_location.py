...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'status_location', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(geography=True))
        # Adding M2M table for field groups on 'Status'
        m2m_table_name = db.shorten_name(u'status_status_groups')
        ...
        db.create_unique(m2m_table_name, ['status_id', 'group_id'])


        # Changing field 'Status.location'
        db.alter_column(u'status_status', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['status.Location']))

    def backwards(self, orm):

        # Changing field 'Location.point'
        db.alter_column(u'status_location', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')())
        # Removing M2M table for field groups on 'Status'
        db.delete_table(db.shorten_name(u'status_status_groups'))


        # User chose to not deal with backwards NULL issues for 'Status.location'
        raise RuntimeError("Cannot reverse this migration. 'Status.location' and its values cannot be restored.")
