...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Status.dateCreated'
        db.add_column(u'status_status', 'dateCreated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Status.dateCreated'
        db.delete_column(u'status_status', 'dateCreated')
    ...
    models = {
        ...
        u'status.status': {
            ...
            'dateCreated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
