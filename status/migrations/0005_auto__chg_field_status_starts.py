...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Status.starts'
        db.alter_column(u'status_status', 'starts', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Status.starts'
        db.alter_column(u'status_status', 'starts', self.gf('django.db.models.fields.DateField')())
