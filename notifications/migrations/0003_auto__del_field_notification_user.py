...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(m2m_table_name, ['notification_id', 'userprofile_id'])


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Notification.user'
        raise RuntimeError("Cannot reverse this migration. 'Notification.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Notification.user'
        db.add_column(u'notifications_notification', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['userprofile.UserProfile']),
                      keep_default=False)
    ...
    models = {
        ...
        u'notifications.notification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initiatingUser': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notificationsInitiated'", 'to': u"orm['userprofile.UserProfile']"}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['status.StatusMessage']", 'null': 'True', 'blank': 'True'}),
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'notifications'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['userprofile.UserProfile']"})
        },
        u'status.location': {
