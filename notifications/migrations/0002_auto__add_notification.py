...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notifications_notification', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['userprofile.UserProfile'])),
            ('initiatingUser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notificationsInitiated', to=orm['userprofile.UserProfile'])),
            ...
            ('notificationType', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
        ))
    ...
    models = {
        ...
        u'notifications.notification': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notifications'", 'to': u"orm['userprofile.UserProfile']"})
        },
        u'status.location': {
