...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'userprofile_userprofile', (
            ...
            ('facebookUID', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
        ...
        m2m_table_name = db.shorten_name(u'userprofile_userprofile_friends')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm[u'userprofile.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm[u'userprofile.userprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_userprofile_id', 'to_userprofile_id'])

        # Adding M2M table for field blockedFriends on 'UserProfile'
        m2m_table_name = db.shorten_name(u'userprofile_userprofile_blockedFriends')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm[u'userprofile.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm[u'userprofile.userprofile'], null=False))
        ...
        # Adding model 'Group'
        db.create_table(u'userprofile_group', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='groups', to=orm['userprofile.UserProfile'])),
        ))
        db.send_create_signal(u'userprofile', ['Group'])

        # Adding M2M table for field members on 'Group'
        m2m_table_name = db.shorten_name(u'userprofile_group_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique(m2m_table_name, ['group_id', 'userprofile_id'])

        # Adding model 'Feedback'
        db.create_table(u'userprofile_feedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.UserProfile'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'userprofile', ['Feedback'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'userprofile_userprofile_friends'))

        # Removing M2M table for field blockedFriends on 'UserProfile'
        db.delete_table(db.shorten_name(u'userprofile_userprofile_blockedFriends'))

        # Deleting model 'Group'
        db.delete_table(u'userprofile_group')

        # Removing M2M table for field members on 'Group'
        db.delete_table(db.shorten_name(u'userprofile_group_members'))

        # Deleting model 'Feedback'
        db.delete_table(u'userprofile_feedback')
