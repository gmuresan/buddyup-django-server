...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.favoritesNotifications'
        db.add_column(u'userprofile_userprofile', 'favoritesNotifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.favoritesNotifications'
        db.delete_column(u'userprofile_userprofile', 'favoritesNotifications')
