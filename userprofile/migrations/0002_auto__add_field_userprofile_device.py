...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.device'
        db.add_column(u'userprofile_userprofile', 'device',
                      self.gf('django.db.models.fields.CharField')(default='ios', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.device'
        db.delete_column(u'userprofile_userprofile', 'device')
