...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.lastGetStatusTime'
        db.add_column(u'userprofile_userprofile', 'lastGetStatusTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.lastGetMessagesTime'
        db.add_column(u'userprofile_userprofile', 'lastGetMessagesTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.lastGetNewDataTime'
        db.add_column(u'userprofile_userprofile', 'lastGetNewDataTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.lastGetStatusTime'
        db.delete_column(u'userprofile_userprofile', 'lastGetStatusTime')

        # Deleting field 'UserProfile.lastGetMessagesTime'
        db.delete_column(u'userprofile_userprofile', 'lastGetMessagesTime')

        # Deleting field 'UserProfile.lastGetNewDataTime'
        db.delete_column(u'userprofile_userprofile', 'lastGetNewDataTime')
    ...
    models = {
        ...
        u'userprofile.userprofile': {
            ...
            'lastGetMessagesTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'lastGetNewDataTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'lastGetStatusTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
